...
Module.onRuntimeInitialized = _ => {		
	...
	const promise = mSigObj.setLicence("537a996c-55c8-4515-b8e8-add81b776bcd", "J3gvQ8YxjrhPjCoIzx/ThFBae4qkm9jGmBvWOoXZjxriLADc9MgZf1QkEbog+Kdf4L+rCrrnGm2HpUFFrQWRxg==");
	promise.then(value => {
	    if (value) {
	        if (navigator.hid) {				
